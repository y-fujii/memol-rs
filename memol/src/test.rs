...
fn test_chord_from_chordpro() {
    ...
    test_chord("C^9#11", &[0, 4, 11, 2, 6]);
    test_chord("C11", &[0, 7, 10, 2, 5]);
    test_chord("C911", &[0, 7, 10, 2, 5]);
    test_chord("C9#11", &[0, 4, 10, 2, 6]);
    test_chord("C13", &[0, 10, 2, 5, 9]);
    //test_chord("C13#11", &[0, 4, 10, 2, 6, 9]);
